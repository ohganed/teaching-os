const CACHE_NAME = 'teaching-os-v0.32.7-physics-simulators-v1';
const APP_SHELL = [
...
function injectTools(html) {
  ...
  const physicsSimulatorsTag = '<script src="./physics-simulators-v1.js"></script>';
  ...
  for (const [name, tag] of [
    ...
    ['physics-simulators-v1.js', physicsSimulatorsTag]
  ]) {
